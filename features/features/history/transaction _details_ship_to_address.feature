...
Feature:  History Details Addresses displayed in Ship to Field
  ...
  Scenario: History: Transaction Details displays Outgoing Address of Four Lines
    ...
    Then select print on Shipping Label - 5 ½" x 8 ½"
    Then set print form mail-from to default
    Then set print form mail-to to address random name, Director, random company, 3217 Shasta Circle S., Los Angeles, CA 90065
    Then set print form email tracking sdoma@stamps.com
    Then select print form service PM Large/Thick Envelope
    Then set print form weight to lbs 0 oz 1
    Then click print label
  ...
  Scenario: History: Transaction Details displays Outgoing Address of Four Lines
    ...
    Then select print on Shipping Label - 5 ½" x 8 ½"
    Then set print form mail-from to default
    Then set print form mail-to to address random name, Director, Human Resources, random company, 3217 Shasta Circle S., Los Angeles, CA 90065
    Then set print form email tracking sdoma@stamps.com
    Then select print form service PM Large/Thick Envelope
    Then set print form weight to lbs 0 oz 1
    Then click print label
