...
#  Scenario: History: Verify Date Selections generates search range of prints with date printed of 'Today'
...
#    Then expect prints within date range Today for column Date Printed are retrieved in the grid
#
#   @advanced_search_date_printed_date_ranges
...
#    Then expect prints within date range Past 7 Days for column Date Printed are retrieved in the grid
  ...
  @advanced_search_date_printed_date_ranges
  Scenario: History: Verify Date Selections generates search range of prints with date printed of 'Past 3 Months'
    ...
    Then click on Sort Descending in the date printed column header dropdown menu list
    Then save last date range value on grid for column date printed
    Then expect prints within date range Past 3 Months for column Date Printed are retrieved in the grid
  ...
  @advanced_search_date_printed_date_ranges
  Scenario: History: Verify Date Selections generates search range of prints with date printed of 'All'
