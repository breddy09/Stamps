Feature: Print a CP72 Label With SDC Insurance for
  ...
  @label_international_with_sdc_ins_PMEI_CP72
  Scenario: History: View Transaction Details for Refund Postage with SDC Insurance for CP72
